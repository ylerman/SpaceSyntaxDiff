...
def visPosNeg(joinedLayer, radii=["n", "250", "500", "750", "1000", "1250", "1500", "2000", "2500", "3000"]):
    ...
    for rad in radii:
        ...
        #Problem in the laptop with Windows 8.1 - missing include library in Pyhton27 in QGIS 2.14 in 64 bit at least
        #Need to search for the solution
        #http://www.lutraconsulting.co.uk/blog/2016/03/02/installing-third-party-python-modules-in-qgis-windows/
        #Need to do this for every QGIS version when updating. Currently working for QGIS 2.12.3
